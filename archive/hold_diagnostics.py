...
M-3: log(pop_jan1) control , does doctor_density importance drop?
M-4: drop 2012 rows , how do poverty and unemployment results change?
"""
...
r("=" * 70)
r("M-3: LOG(POP) CONTROL , does doctor_density importance change?")
r("=" * 70)
...
r()
r("=" * 70)
r("M-4 SUBSTANTIVE: DROP 2012 ROWS , poverty and unemployment results")
r("=" * 70)
